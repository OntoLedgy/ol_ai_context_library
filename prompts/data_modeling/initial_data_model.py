...
from graph_rag.orchestrators.neo4j_runway.utils.data.data_dictionary.data_dictionary import DataDictionary
...
if TYPE_CHECKING:
    from graph_rag.orchestrators.neo4j_runway.models.core.node import Nodes
...
def create_initial_data_model_prompt(
    ...
    prefix = "I would like you to generate a graph data model based on this provided information. Ensure that the recommended nodes are implemented in the final data model."
